                    ...
                    <div className='border border-gray-200  shadow-lg flex flex-col justify-center items-center py-5 px-5 rounded-lg'>
...

                        {
                            timeline.length === 0 ? <div>
                                <h1 className='text-3xl font-bold text-gray-600'>No Interaction Logged Out</h1>
                            </div> : <PieChart style={{ width: '100%', maxWidth: '500px', maxHeight: '40vh', aspectRatio: 1 }} responsive>
                                <Pie
                                    data={data}
                                    innerRadius="80%"
                                    outerRadius="100%"
